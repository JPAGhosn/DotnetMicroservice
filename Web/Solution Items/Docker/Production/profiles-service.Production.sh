...
kubectl delete service profiles-cluster-ip-service profiles-database-cluster-ip profiles-database-load-balancer profiles-database-nodeport profiles-node-port;

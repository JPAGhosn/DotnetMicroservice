...
kubectl delete secrets postgrescollections;
kubectl create secret generic postgrescollections --from-literal=POSTGRES_PASSWORD=admin;

kubectl delete deployments collections-service collections-database-deployment;
kubectl delete service collections-cluster-ip-service collections-database-cluster-ip collections-database-load-balancer collections-database-nodeport collections-node-port;
